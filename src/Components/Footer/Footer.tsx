  ...
  return (
    <footer className="w-full p-4 bg-gray-800 sm:p-6">
      <div className="md:flex md:justify-between">
        ...
        <div className="flex mx-auto grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
          ...
          <div>
            ...
            <ul className="text-gray-600 dark:text-gray-400">
              <li>
                <a href="https://github.com/kamilbochno" className="hover:underline ">
                  Github
                </a>
              </li>
              <li>
      ...
      <div className="sm:flex sm:items-center sm:justify-between">
        <span className="flex mx-auto text-sm text-gray-500 sm:text-center dark:text-gray-400">
          © 2023{" "}
          <a href="/" className="hover:underline">
            AutoFixSolutions™
          </a>
        ...
        <div className="flex mx-auto mt-4 space-x-6 sm:justify-center sm:mt-0">
