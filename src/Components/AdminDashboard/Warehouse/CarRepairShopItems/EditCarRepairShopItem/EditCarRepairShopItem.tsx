...
function CarRepairShopItemEdit() {
  ...
  const handleSubmitCarRepairShopItemEdit = async (e) => {
    e.preventDefault();
    ...
    const key = carRepairShopItem.key;
    const itemId = carRepairShopItem._id;
          ...
          <div className="relative p-4 flex-auto">
            <form className="px-8 w-full" onSubmit={handleSubmitCarRepairShopItemEdit}>
              <div className="grid grid-cols-2 w-72 lg:w-96">
                ...
                <textarea
                  defaultValue={carRepairShopItem.description}
                  name="description"
                ...
                <input
                  defaultValue={carRepairShopItem.price}
                  name="price"
                  className="shadow mb-2 appearance-none border rounded w-full py-2 px-1 text-black"
                />
                <label className="block text-sm font-medium text-black mt-3">Quantity</label>
                <input
                  defaultValue={carRepairShopItem.quantity}
                  name="quantity"
                  className="shadow mb-2 appearance-none border rounded w-full py-2 px-1 text-black"
                />
                ...
                <select
                  defaultValue={carRepairShopItem.category}
                  name="category"
