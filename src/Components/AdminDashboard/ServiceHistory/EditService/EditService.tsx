...
function EditService() {
  ...
  if (!isOpenEditService) return null;
      ...
      <div className="relative w-auto my-6 mx-auto max-w-3xl">
        <div className="border-0 rounded-lg shadow-lg relative flex flex-col w-full bg-white outline-none focus:outline-none">
          <div className="flex items-center justify-between p-6 border-b border-solid border-gray-300 rounded-t ">
            <h3 className="text-3xl font=semibold mx-auto">Edit Service</h3>
            <button
              type="button"
              onClick={() => setIsOpenEditService(false)}
          ...
          <div className="relative p-4 flex-auto">
            <form className="px-8 w-full" onSubmit={handleSubmitEditService}>
