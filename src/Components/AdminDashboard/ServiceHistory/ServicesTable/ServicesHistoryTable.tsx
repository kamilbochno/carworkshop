...
function ServicesHistoryPaginated({ itemsPerPage }) {
  const { services, setIsOpenAddService } = useContext<any>(AdminServicesHistoryContext);
    ...
    <>
      ...
      <div className="mx-auto text-center mt-4">
        <button
          ...
          className="bg-blue-500 hover:bg-blue-600 h-8 w-24 rounded-lg text-white mb-4 text-sm">
          Add service
        </button>
      </div>
    </>
