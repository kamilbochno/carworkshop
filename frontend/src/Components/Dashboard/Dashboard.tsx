...
import OrderHistoryPaginated from "./DashboardTables/OrderHistoryTable.tsx";
import OrderHistoryDetails from "./OrderHistory/OrderHistoryDetails.tsx";
      ...
      <div className="bg-gray-100 py-6">
        ...
        <div className="h-full mx-auto max-w-7xl py-6 px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 grid-cols-1 gap-x-4 gap-y-8">
            <div className="bg-white h-96 rounded-lg border-2 border-solid border-gray-300">
              ...
              <div className="mt-4 relative overflow-x-auto">
                <div>
                  <ServicesHistoryPaginated itemsPerPage={3} />
                  <ServiceDetails />
                </div>
              </div>
            </div>
            <div className="bg-white h-96 rounded-lg border-2 border-solid border-gray-300">
              ...
              <div className="mt-4 relative overflow-x-auto">
                <CarsOverviewPaginated itemsPerPage={3} />
          ...
          <div className="mt-6 bg-white h-96 rounded-lg border-2 border-solid border-gray-300">
            ...
            <div className="mt-4 relative overflow-x-auto">
              <AppointmentsPaginated itemsPerPage={3} />
              <button className="w-24 h-8 flex mx-auto bg-blue-500 rounded-lg hover:bg-blue-600 mt-4 tracking-tight">
                <NavLink
          ...
          <div className="grid lg:grid-cols-2 grid-cols-1 gap-x-4 gap-y-8 mt-6 mb-12">
            <div className="bg-white rounded-lg border-2 border-solid border-gray-300 overflow-x-auto">
              <div className="mt-4 text-2xl tracking-tight text-gray-600 text-center">
                Order history
              </div>
              <OrderHistoryPaginated itemsPerPage={3} />
              <OrderHistoryDetails />
            </div>
